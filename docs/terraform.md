...
| <a name="input_domain_lists"></a> [domain\_lists](#input\_domain\_lists) | Map of Route 53 Resolver DNS Firewall domain lists | <pre>map(object({<br>    name    = string<br>    domains = list(string)<br>  }))</pre> | n/a | yes |
...
| Name | Description |
|------|-------------|
| <a name="output_domain_lists"></a> [domain\_lists](#output\_domain\_lists) | Route 53 Resolver DNS Firewall domain lists |
